...
def preprocessdata(data):
    ...
    #tokenization
    data['externalStatus'] = data['externalStatus'].apply(lambda text: ' '.join(text.split()))  # Split and rejoin
    data['internalStatus'] = data['internalStatus'].apply(lambda text: ' '.join(text.split()))  # Split and rejoin
...
#function to vectorize the textual data
def vector(X_train):
...
#ensemble model of feedforward and randomforest
